...
Tenho desenvolvido projetos de pipelines utilizando Python, SQL, AWS, dbt e Apache Airflow, aplicando boas práticas de automação, modelagem e confiabilidade das informações.
