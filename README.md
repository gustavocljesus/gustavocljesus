...
Tenho desenvolvido projetos de engenharia de dados utilizando Python e SQL para construir pipelines de dados, aplicando ferramentas de orquestração, transformação e plataformas em nuvem para criar soluções confiáveis e escaláveis.
